...
// Recalled-content cache (newmsgid -> preview). The 269340/269341 receive-path hook fills it
...
// Build the cached preview for a received message: trimmed/truncated text for the
// plain-text type (1), or a localized type placeholder ("[图片]"/"[语音]"/…) for media. Caller
...
// Exercises the production Message-finalizer capture path with the same 269340/269341 field
