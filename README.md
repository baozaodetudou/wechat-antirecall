...
**[下载最新版](https://github.com/baozaodetudou/wechat-antirecall/releases)** · [遇到问题](#遇到问题) · [进阶用法](#进阶用户命令行)

> **使用前先看**
>
> - 支持 **Apple Silicon（M 系列）Mac**；Intel Mac 当前精确支持微信 **4.1.12（构建号 269341）**。
> - 安装前请先**完全退出微信**。
...
把 Releases 中的 `WeChatAntiRecall-v*.dmg` 发给对方即可。不要发送已经修改过的 `WeChat.app`，也不需要让对方下载源码。

对方按下面的“3 分钟完成安装”操作。Intel Mac 还需要确认微信是 **4.1.12（构建号 269341）**；其他 Intel 微信版本会被工具拒绝，不会猜测补丁地址。
...
打开 **[Releases](https://github.com/baozaodetudou/wechat-antirecall/releases)**，下载最新的 `.dmg`，然后把「微信防撤回」拖进「应用程序」。
...
> Intel 微信 4.1.12（269341）的提示显示在微信窗口顶部，约 4 秒后自动消失，不会写入聊天记录；Apple Silicon 仍沿用微信聊天流内的系统提示路径。

> 如果页面提示无权读取已保存的短语，按页面按钮为本 App 开启「完全磁盘访问」，然后退出并重新打开本 App。

> `{content}` 的完整内容预览目前只在构建号 **269340、269341** 上启用，并且只能读取本次微信启动后收到的消息。其他情况会自动省略内容，不会显示多余的冒号或空白。
...
支持。发布的 GUI、CLI 和运行时均为 Universal Binary；Intel Mac 当前只验证并支持微信 **4.1.12（构建号 269341）**，其他微信构建号仍只支持 Apple Silicon。
...
| 微信版本 | 构建号 | 架构 | 静默防撤回 | 自定义提示 | `{content}` 内容预览 | 屏蔽自动更新 | 历史多开补丁 |
| --- | --- | --- | :---: | :---: | :---: | :---: | :---: |
| 较早构建 | `268575` | Apple Silicon | ✅ | — | — | ✅ | ✅ |
| 较早构建 | `268596` | Apple Silicon | ✅ | — | — | ✅ | — |
| 较早构建 | `268597` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 较早构建 | `268599` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 较早构建 | `268601` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 较早构建 | `268602` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 较早构建 | `268831` | Apple Silicon | ✅ | ✅ | — | — | — |
| 4.1.10 | `268849` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 4.1.10 | `268850` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 4.1.10 | `268851` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 4.1.11 | `269077` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 4.1.11 | `269079` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 4.1.11 | `269110` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 4.1.12 | `269332` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 4.1.12 | `269333` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 4.1.12 | `269334` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 4.1.12 | `269338` | Apple Silicon | ✅ | ✅ | — | ✅ | — |
| 4.1.12 | `269340` | Apple Silicon | ✅ | ✅ | ✅ | ✅ | — |
| 4.1.12 | `269341` | Apple Silicon / Intel | ✅ | ✅ | ✅ | ✅ | — |
